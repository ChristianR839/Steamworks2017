...
public class instrumentation {
	...
	public static void process(com.ctre.CANTalon.MotionProfileStatus status1) {
		...
		if((now-timeout) > 0.2){
			...
			System.out.format("%-9s\t", (status1.hasUnderrun ? "1" : "0"));
			System.out.format("%-9s\t", (status1.isUnderrun ? "1" : "0"));
			System.out.format("%-9s\t", (status1.activePointValid ? "1" : "0"));
			System.out.format("%-9s\t", (status1.activePoint.isLastPoint ? "1" : "0"));
			System.out.format("%-9s\t", (status1.activePoint.velocityOnly ? "1" : "0"));
